...
public class SignInActivity extends AppCompatActivity
    ...
    //creating a reference to the firebase authentiction library
    private FirebaseAuth mAuth;
    private FirebaseAuth.AuthStateListener mAuthListener;//this will detect the changes in the user's current authentication state
    ...
    private void createUserAccount() {
        ...
        mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            @Override   //addOnCompleteListener is used to notify when the process is completed
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful())
                {
